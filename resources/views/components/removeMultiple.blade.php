...
<th>
    ...
    <dialog id="confirmDialog" class="modal dialog w-80 p-2 bg-white rounded"> 
        <div class="flex flex-col">
            <div class="p-4">
                <p class="text-xs text-center font-normal text-red-500">You are about to delete multiple Products that would affect multiple tables, are you sure you want to delete the selected products?</p>
            </div>
