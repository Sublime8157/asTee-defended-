    ...
    <body>
        {{-- Container  --}}
                <div class="flex items-center justify-center w-screen h-screen">
                    {{-- Form Starts Here --}}
                    <form action="" class="relative flex items-center justify-center bg-blue-100 p-10   rounded-lg flex-col shadow-2xl">
                        {{-- User Icon  --}}
                        ...
                        <div class="mb-5 w-full">
                                ...
                                <input type="text" class=" rounded-md  ps-8 py-2  w-64 md:w-96  outline-none border-none shadow-sm">
                        </div>
                        {{-- Password input --}}
                        <div>
                                ...
                                <input type="password" class=" runded-md ps-8 py-2 w-64 md:w-96 outline-none border-none shadow-sm">
                        </div>
                        {{-- Forgot Password --}}
