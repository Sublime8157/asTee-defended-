    ...
    <dialog class=" modal bg-white shadow-lg rounded p-10  w-8/12" id="addProdForm"> 
        ...
        <form action="" class="flex justify-center  items-start flex-row-reverse" method="POST" id="submitFormCancelReturn">
           ...
           <div class="hidden">
            ...
            <input type="text" name="userId" value="8157" id="userId">
           </div>                    
           <div class="flex flex-row items-start flex-wrap">
             {{-- Choose Variation Type --}}
               ...
               <div class="me-2">
                    ...
                    <textarea name="reason" id="reason" cols="50" rows="2" class="text-xs rounded"></textarea>
                </div>
           </div>
           {{-- Image input --}}
            <div class="flex  items-center mt-10 flex-col">
                <div class="relative border-2 border-dashed rounded-md me-5 self-center mb-5">
                    ...
                    <img src="#" alt="imagePreview" style="display: none; height: 200px;" class="absolute absolute-center bg-white" id="image-preview" width="400px">
                </div>
                {{-- Buttons --}}
