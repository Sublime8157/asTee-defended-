            ...
            <div class="mx-10 pb-10 flex justify-center">
                <table class="">
                   ...
                   <tr>
                       ...
                       <td></td>
                       <td colspan="3" class=" w-24"><button type="submit" class="text-xs rounded w-14 px-2 py-1  text-white cursor-pointer" style="background-color: #ff8906">Filter</button></td>
                   </tr>
                   ...
                   @foreach($storeOnHand as $product) 
                   <tr class=" text-xs">
                        <td class="ps-2">{{$product->id}} </td>
                        {{-- Get the image path  --}}
                        <td class="ps-2"><img src="{{ asset('storage/images/' . $product->image_path ) }}" alt="Product Image" width="50px"></td>
                   ...
                   {{-- Image input --}}
                    <div class="flex items-center flex-col">
                        <div class="relative border-2 border-dashed rounded-md me-5 self-center mb-5">
                            ...
                            <input type="file" name="image_path" class="py-20 cursor-pointer opacity-0">
                    </div>
                    <div>
