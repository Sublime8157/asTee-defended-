...
@section('content')
<div class="flex bg-blue-50 justify-center flex-col items-center h-screen w-screen ">
    <h1 class="text-center font-bold text-5xl  text-blue-400">AsTee</h1>
    <div class=" w-full md:w-6/12 flex flex-col items-center justify-start    rounded py-5 px-10">
        <div class="w-full">  
            <div class="w-full flex items-center justify-center flex-col">
                <div class="text-xl self-start  mb-2 font-bold text-gray-800">{{ __('Reset Password') }}</div>
                <hr class="w-full">
                <div class="w-full mt-2 ">
                    <form method="POST" class="w-full" action="{{ route('userPassword.update') }}">
                        @csrf
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="w-full bg-yellow-400 py-2 text-white rounded hover:opacity-70 text-lg">
                                    {{ __('Reset Password') }}
                                </button>
                            </div>
                        </div>
